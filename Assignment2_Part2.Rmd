...
3. Are the parameter estimates changing? (way 1) # the posterior describing old data
4. How does the new data look in last year's predictive posterior? (way 2) # how the posterior moves with the new data
